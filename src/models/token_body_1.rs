...
pub enum TokenBody1 {
    ...
    AuthorizationCode(Box<models::AuthorizationCodeCredentials>),
    #[serde(rename="client_credentials")]
    ClientCredentials(Box<models::ClientCredentials>),
    #[serde(rename="refresh_token")]
    RefreshToken(Box<models::RefreshTokenCredentials>),
}

impl Default for TokenBody1 {
    fn default() -> Self {
        Self::AuthorizationCode(Default::default())
    }
}
