...
/// ProviderAccessTokenResponse : The OAuth token response for the implementation provided by the authorization server.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProviderAccessTokenResponse {
...
impl ProviderAccessTokenResponse {
    /// The OAuth token response for the implementation provided by the authorization server.
    pub fn new(access_token: String, expires_in: i32, token_type: TokenType) -> ProviderAccessTokenResponse {
