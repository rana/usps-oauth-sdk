...
/// TokensResponse : The IETF standard tokens response. Contains access and optional refresh token values.
...
impl TokensResponse {
    /// The IETF standard tokens response. Contains access and optional refresh token values.
    pub fn new(access_token: String, expires_in: i32, token_type: TokenType, refresh_token: String) -> TokensResponse {
        TokensResponse {
            access_token,
            expires_in,
            token_type,
